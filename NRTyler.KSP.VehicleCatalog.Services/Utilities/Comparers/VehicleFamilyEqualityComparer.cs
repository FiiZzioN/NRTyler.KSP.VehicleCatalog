...
{
    public class VehicleFamilyEqualityComparer : EqualityComparer<VehicleFamily>
    {
        ...
        public override bool Equals(VehicleFamily x, VehicleFamily y)
        {
        ...
        public override int GetHashCode(VehicleFamily obj)
        {
            if (obj is null)
            {
                return 0;
